...
<div class="con bounce-in-right"><!--contain to move-->
   <div class="shape glow2">
     <div class ="text1 glow1">
    	<div class="ufo">
		
			<h2><c:out value="${book.user.userName}"/>Location</h2>
			
			<h3><c:out value="${ufo.location}"/><h3>
			
			<p>Time: <c:out value="${ufo.time}"/></p>
			

				
			<p><c:out value="${ufo.description}"/></p>
			<p>Number of witnesses <c:out value="${ufo.witnesses}"/></p>
			
		<div class="edit">
			<a class="button2" href="/ufos/${ufo.id}/edit"><img src="https://img.icons8.com/ios-filled/50/664DB2/edit--v1.png"/></a><br/>
			<a href="/ufos/delete/${id}"><img src="https://img.icons8.com/external-kiranshastry-solid-kiranshastry/64/664DB2/external-delete-multimedia-kiranshastry-solid-kiranshastry.png"/></a>
		</div>
	</div>
