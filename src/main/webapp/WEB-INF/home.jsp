...
<div class="con bounce-in-right"><!--contain to move-->
   <div class="shape glow2">
     <div class ="text1">
    	<p> Welcome to the U.F.O Menu.
      	This site is intended to log and collect data on UFO/UAP sightings. It was my intention to create
      	 a online space and community that is judgment free and serious about U.F.O's! 
       	You wont find any non-credible evidence here the site is dedicated to the truth
       	 and is based on the reality of the phenomenon. I plan to expand this site regularly 
        and create a seem-less experience using a google geo location API hot map. So that we
         may more closely examine the phenomenon after we collect data.
        </p>
         
		<p>     
		 The goal is to create a public data tool set for anyone to use and to share for scientific purposes. 
		To create UFO report content and to share in the love of the subject. in a regulated and controlled form. 
		So we might use the data to unlock the mysteries or the locations to see one for ourselves!
		</p>
